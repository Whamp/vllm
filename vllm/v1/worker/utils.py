...
class KVBlockZeroer:
    ...
    def __init__(
        ...
        for group in attn_groups_iter:
            ...
            # side (SingleTypeKVCacheManager._record_new_block_ids). Gating on
            # FullAttentionSpec left the sliding-window families (the SWA KV
        ...
        logger.info(
            "KVBlockZeroer segments: %s",
            {gid: m[5] for gid, m in sorted(self._group_meta.items())},
        )
