...
def dsa_indexer_uses_fp4(vllm_config: VllmConfig) -> bool:
    ...
    if use_fp4 and not supports_mxfp4_indexer_cache():
        raise ValueError(
            "indexer_kv_dtype='mxfp4' requires an NVIDIA SM86 or SM100-family GPU."
        )
    return use_fp4
...
class DeepseekV32IndexerMetadataBuilder(AttentionMetadataBuilder):
    ...
    def build(
        ...
        if num_decodes > 0:
            ...
            # Build scheduling metadata for the exact row slice this rank scores.
