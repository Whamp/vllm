...
- `fp4_kv/REPORT.md`: matched FP8 and FP4 cache comparison
- `iq1/PERF-PREP-20260821.md`: Unsloth IQ1 implementation and performance record
- `DCP-SM86.md`: DCP implementation, correctness fixes, performance, and 262K limit
- `EVIDENCE.md`: immutable raw logs, traces, numerical dumps, and checksums

### Earlier Whamp/club-3090 source commits
