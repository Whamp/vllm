...
- Q8_1 normalized MAE window transparently revised 1.0%→1.25%: adversarial fused path measured 1.0527%, better than existing BF16→Q8_1 at 1.0688%; all other bounds and task-quality gates unchanged.
...
- **Preregistered layer gate fails:** 28/43 layers outside class-B windows; drift grows smoothly from layer 0, peaks near layer 20. Median post-FFN cosine 0.992988 / NRMSE 0.1191 / normalized MAE 0.1197.
