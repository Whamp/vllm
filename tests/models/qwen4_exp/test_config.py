...
from vllm.models.qwen4_exp.common.quantization import (
    without_qwen4_exp_modelopt_fp4,
)
...
def test_qwen4_exp_modelopt_fp4_filter_is_scope_specific() -> None:
    modelopt_fp4 = SimpleNamespace(get_name=lambda: "modelopt_fp4")
    fp8 = SimpleNamespace(get_name=lambda: "fp8")

    assert without_qwen4_exp_modelopt_fp4(modelopt_fp4) is None
    assert without_qwen4_exp_modelopt_fp4(fp8) is fp8
    assert without_qwen4_exp_modelopt_fp4(None) is None
