...
transposed or mis-fused load, so we added coordinate oracles: for every
...
1.0527% NMAE vs the 1.0% bound, better than the existing BF16→Q8_1 at 1.0688%
...
- **Write the contract before the kernels.** The L0 oracle caught a real
  ...
  (A2) is the only thing that would have caught a transposed or mis-fused
